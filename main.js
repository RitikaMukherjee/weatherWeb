const api = {
  ...
  function displayResults2(forecast){
    ...
    day1.innerText = `day 1:\n\n${Math.round(forecast.list[4].main.temp)-273}°c\n${forecast.list[4].weather[0].main}`;
    let day2 = document.querySelector('.forecast .day2');
    day2.innerText = `day 2:\n\n${Math.round(forecast.list[12].main.temp)-273}°c\n${forecast.list[12].weather[0].main}`
    let day3 = document.querySelector('.forecast .day3');
    day3.innerText = `day 3:\n\n${Math.round(forecast.list[20].main.temp)-273}°c\n${forecast.list[20].weather[0].main}`
    let day4 = document.querySelector('.forecast .day4');
    day4.innerText = `day 4:\n\n${Math.round(forecast.list[28].main.temp)-273}°c\n${forecast.list[28].weather[0].main}`
    let day5 = document.querySelector('.forecast .day5');
    day5.innerText = `day 5:\n\n${Math.round(forecast.list[34].main.temp)-273}°c\n${forecast.list[34].weather[0].main}`
  }
